    ...
    <header className="sticky top-0 z-50 w-full bg-[#0A0406]/95 backdrop-blur-md border-b border-[#3D0C15]/70 transition-all duration-300 shadow-[0_4px_24px_rgba(0,0,0,0.7)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 h-20 flex items-center justify-between">
        ...
        <button 
          ...
          aria-label="Masung Steakhouse Reserve Home"
        >
          ...
          <span className="block text-[9px] uppercase tracking-[0.35em] text-[#D4AF37] font-sans -mt-0.5">
            Reserve Edition
          </span>
        </button>
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          >
            <span>Smokehouse View</span>
            <ArrowUpRight className="w-3 h-3 text-[#D4AF37]" />
          </button>

          {/* Carving Board Order Pill */}
          <button
            ref={cartBadgeRef}
            onClick={() => handleNav('reserve-shop')}
            ...
            aria-label={`Carving Board Order with ${totalQuantity} items`}
          >
